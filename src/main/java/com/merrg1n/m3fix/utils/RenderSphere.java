...
//        glBufferSubData(GL_ARRAY_BUFFER, (long) vertices_count * (3) * 4, buffered_normals);
        glBufferSubData(GL_ARRAY_BUFFER, (long) vertices_count * (2) * 4, buffered_uv);
...
//        glBindBuffer(GL_ARRAY_BUFFER, vbo);
        ...
        glVertexPointer(3, GL_FLOAT, buffered_vertices);

//        glEnableClientState(GL_NORMAL_ARRAY);
//        glNormalPointer(GL_FLOAT, 0, (long) vertices_count * (3) * 4);

        glEnableClientState(GL_TEXTURE_COORD_ARRAY);
        glTexCoordPointer(2, GL_FLOAT, buffered_uv);
...
//        glColor3f(0.0F, 0.0F, 0.0F);
        glDrawElements(GL_TRIANGLES, buffered_indexes);
//        glBindBuffer(GL_ARRAY_BUFFER, 0);
//        glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, 0);
